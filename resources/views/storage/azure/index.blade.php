    ...
    <div class="container py-5">
        ...
        <div class="row mb-5">
            <div class="col-lg-10 mx-auto text-center">
                ...
                <h1 class="display-5 fw-bold mb-2 text-primary">Azure Storage</h1>
                <p class="lead text-secondary mb-4">Upload and view your files securely in the cloud.</p>
            </div>
        </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow border-0">
                    <div class="card-body p-4">
                        ...
                        @endif
                        <form action="{{ route('azure.upload.api') }}" method="POST" enctype="multipart/form-data" class="row g-3 align-items-center justify-content-center">
